...
class IssueSerializer(serializers.ModelSerializer):
    """
    Serializer pour le modèle Issue. Il sérialise et désérialise les données en format JSON et valide également les
    données avant de créer une instance d'Issue.
    ...
    def create(self, validated_data):
        """
        Crée et renvoie une nouvelle instance d'Issue avec les données validées.
    ...
    def validate_author_user_id(self):
        ...
        Returns:
            CustomUser: L'instance de `CustomUser` qui correspond à l'ID de l'utilisateur auteur validé.
        """
